...
public class ContactsPageTest extends TestBase{
	...
	String sheetName = "FreeCRMTestData";
	
	org.apache.log4j.Logger log=org.apache.log4j.Logger.getLogger(ContactsPageTest.class);
	...
	public void verifyContactsPageLabel(){
		...
		log.info("**************Validating contact label***************** ");
	...
	public void validateCreateNewContact(String title, String firstName, String lastName, String company) throws InterruptedException{
		...
		log.info("**************Clicking on new contacts ***************** ");
